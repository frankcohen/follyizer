...
The project was created for the **Gothic Folly Cathedral** installation at **Burning Man 2026**, but it is intended to be useful for any installation using Falcon Player, including holiday light displays, public art, museums, festivals, and other distributed lighting systems.
